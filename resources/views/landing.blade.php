...
<head>
    ...
    <link rel="stylesheet" href="/parmisi/manual_assets/app.css">
    ...
    <header class="bg-white/95 backdrop-blur-sm shadow-md border-b border-white/10 w-full z-20 sticky top-0">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <div class="flex items-center justify-center sm:justify-start">
                ...
                <link href="{{ asset('manual_assets/app.css') }}" rel="stylesheet">
                <script src="{{ asset('manual_assets/app.js') }}"></script>
    ...
    <main class="flex-grow flex flex-col items-center justify-start py-12 px-4 sm:px-6 lg:px-8 z-10">
        <div class="max-w-7xl w-full">
            ...
            <div class="text-center mb-12"> 
                <h1 class="text-5xl sm:text-7xl font-black text-white tracking-tight mb-2 drop-shadow-lg">
                    PARMISI
                </h1>
